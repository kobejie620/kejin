...
class WxPayConf_pub {
    ...
    const APPID = 'wx8294dd0fe1a0497a';
    //受理商ID，身份标识
    const MCHID = '1228221602';
    //商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    const KEY = 'e89cb43b9b0b92d83f104e7c2a18e7a0';
    //JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    const APPSECRET = 'a83939da0c9c59c88a22782b93213e37';
    //=======【JSAPI路径设置】===================================
    ...
    const NOTIFY_URL = 'http://youyibao.wx.cuci.cc/index.php/Wap/Notify/index';
    //=======【curl超时设置】===================================
