...
function check_link($name) {
    return '<a tabindex="0" target="_blank" role="button" data-placement="top" data-toggle="popover" data-trigger="focus" data-content="' . $name . '" target="_blank">' . 'view' . '</a>';
//    return '<a data-container="body" data-toggle="popover" data-placement="top" data-content="' . $name . '" target="_blank">' . 'view' . '</a>';
}
