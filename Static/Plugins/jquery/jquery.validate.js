...
jQuery(function () {
    ...
    function getPattern(pattern) {
        switch (pattern) {
            ...
            case 'qq':
                return /^[1-9][0-9]{4,}$/i;
            case 'id':
                return /^\d{15}(\d{2}[0-9x])?$/i;
            case 'ip':
                return /^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/i;
            case 'zip':
                return /^\d{6}$/i;
            case 'mobi':
                return /^1\d{10}$/;
            case 'phone':
                return /^((\d{3,4})|\d{3,4}-)?\d{7,8}(-\d+)*$/i;
            case 'url':
                return /^[a-zA-z]+:\/\/(\w+(-\w+)*)(\.(\w+(-\w+)*))+(\/?\S*)?$/i;
            case 'date':
                return /^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)$/i;
            case 'datetime':
                return /^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29) (?:(?:[0-1][0-9])|(?:2[0-3])):(?:[0-5][0-9]):(?:[0-5][0-9])$/i;
            case 'int':
                return /^\d+$/i;
            case 'float':
            case 'number':
    ...
    /**
     * Validate 验证Pattern属性
     * @author zoujingli <zoujingli@qq.com>
     */
    jQuery.validator.addMethod("pattern", function (value, element) {
        value += '';
        var regexp = new RegExp(getPattern(element.pattern));
        var result = this.optional(element) || regexp.test(value);
        if (!result) {
            element.focus();
        }
        return result;
