...
(function (window, undefined) {
            ...
            TouchSlider = function (opt) {
                ...
                try {
                    ...
                    for (var i = 0; i < this.instance.length; i++) {
                        if (this.instance[i] == this.container)
    ...
    TouchSlider.prototype = {
        ...
        _move: function (e) {
            if (!this.scrolling || e.touches && e.touches.length > 1 || e.scale && e.scale !== 1)
                return;
            ...
            if (this.scrolling === 2 || Math.abs(offx) >= Math.abs(this.endPos[yx] - this.startPos[yx])) {
                ...
                if (offx != 0)
                    this.scrolling = 2;//标记拖动（有效触摸）2
            } else
                this.scrolling = 0;//设置为摒弃标记0
        },
        _end: function (e) {
